...
const Footer = () => {
  return (
    ...
    mx-auto py-16 px-4 grid lg:grid-cols-3 
    gap-8 text-gray-300"
    >
      <div>
        <h1
        ...
        >React Tailwind</h1>
        <p  className='py-4 max-w-[300px]'>lorem dfdgcsvcbgf hdgdfvcjg cnvb
        nvbfgdcsv nvbghfgdccbcmj nbhgbfvdj
        b sdfcvfhg nvhbkjg nbjjlkkouiy 
        </p>
